...
Relational databases are the actual database, or thing holding all the data. SQL is the language used to communicate with relational databases.

2. Why do tables need a Primary Key?
They need a primary key because primary keys identify the unique records stored in every table. Primary keys can then serve as foreign keys in other tables.
